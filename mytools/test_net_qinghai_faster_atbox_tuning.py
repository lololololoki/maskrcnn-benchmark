...
def main():
    ...
    parser.add_argument(
        ...
        default="configs/coco_qinghai_lr0.002_512_tuning/e2e_faster_rcnn_X_101_32x8d_FPN_atbox_1x_gpu3_bquad.yaml",
        metavar="FILE",
    ...
    parser.add_argument(
        "--weight",
        default="output/qinghai_lr0.002_512_tuning/e2e_faster_rcnn_X_101_32x8d_FPN_atbox_1x_gpu3_bquad/model_",
        metavar="FILE",
