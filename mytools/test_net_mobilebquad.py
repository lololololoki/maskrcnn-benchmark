...
def main():
    ...
    parser.add_argument(
        ...
        default="configs/coco_qinghai_lr0.002_512/e2e_bquad_rcnn_X_101_32x8d_FPN_1x_gpu3_mobilebquad.yaml",
        metavar="FILE",
    ...
    parser.add_argument(
        "--weight",
        default="output/qinghai_lr0.002_512/e2e_bquad_rcnn_X_101_32x8d_FPN_1x_gpu3_mobilebquad/model_",
        metavar="FILE",
