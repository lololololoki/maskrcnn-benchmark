...
def main():
    ...
    parser.add_argument(
        ...
        default="configs/coco_mapping_challenge_small/e2e_bquad_rcnn_R_101_32x8d_FPN_1x_gpu3_trec.yaml",
        metavar="FILE",
    ...
    parser.add_argument(
        "--weight",
        default="output//coco_mapping_challenge_small/e2e_bquad_rcnn_R_101_32x8d_FPN_1x_gpu3_trec/model_",
        metavar="FILE",
