...
def main():
    ...
    parser.add_argument(
        ...
        default="configs/coco_qinghai_lr0.001/e2e_faster_rcnn_R_101_FPN_1x_gpu1_trec.yaml",
        metavar="FILE",
    ...
    parser.add_argument(
        "--weight",
        default="output/qinghai_lr0.001/e2e_faster_rcnn_R_101_FPN_1x_gpu1_trec/model_",
        metavar="FILE",
