...
def main():
    ...
    parser.add_argument(
        ...
        default="configs/coco_qinghai_suburban/e2e_mask_rcnn_X_101_32x8d_FPN_1x_gpu3_trec.yaml",
        metavar="FILE",
    ...
    parser.add_argument(
        "--weight",
        default="output/coco_qinghai_suburban/e2e_mask_rcnn_X_101_32x8d_FPN_1x_gpu3_trec/model_",
        metavar="FILE",
