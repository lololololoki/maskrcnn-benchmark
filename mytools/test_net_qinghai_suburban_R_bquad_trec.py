...
def main():
    ...
    parser.add_argument(
        "--config-file",
        # default="configs/coco_fujian_X-101/e2e_faster_rcnn_X_101_32x8d_FPN_1x_gpu3_mask.yaml",
        default="configs/coco_qinghai_suburban/e2e_mask_rcnn_R_101_32x8d_FPN_1x_gpu3_trec.yaml",
        metavar="FILE",
    ...
    parser.add_argument(
        "--weight",
        default="output/coco_qinghai_suburban/e2e_mask_rcnn_R_101_32x8d_FPN_1x_gpu3_trec/model_",
        metavar="FILE",
