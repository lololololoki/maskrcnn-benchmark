...
def main():
    ...
    parser.add_argument(
        ...
        default="configs/coco_fujian_X-101_512/e2e_faster_rcnn_X_101_32x8d_FPN_1x_gpu3_bquad.yaml",
        metavar="FILE",
    ...
    parser.add_argument(
        "--weight",
        default="output/fujian_X-101_512/e2e_faster_rcnn_X_101_32x8d_FPN_1x_gpu3_bquad/model_",
        metavar="FILE",
