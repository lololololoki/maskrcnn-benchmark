...
class DatasetCatalog(object):
    ...
    DATASETS = {
        ...
        "coco_mapping_challenge_train": (
            "coco_mapping_challenge_train/images",
            "coco_mapping_challenge_train/annotation-hasbbox-filter.json",
        ),
        "coco_mapping_challenge_val": (
            "coco_mapping_challenge_val/images",
            "coco_mapping_challenge_val/annotation-hasbbox-filter.json",
        ),
        "coco_qinghai_train": (
            "coco_qinghai/images",
