import numpy as np
import argparse
from maskrcnn_benchmark.modeling.ICSTN import warp
...
def set(training):
	...
	parser.add_argument("--netType", default="IC-STN", choices=["CNN","STN","IC-STN"],		help="type of network")
	...
	parser.add_argument("--warpN",		type=int,	default=3,				help="number of recurrent transformations (for IC-STN)")
	...
	print ("[opt.warpType] {}".format(opt.warpType))
	print("[opt.warpN] {}".format(opt.warpN))
