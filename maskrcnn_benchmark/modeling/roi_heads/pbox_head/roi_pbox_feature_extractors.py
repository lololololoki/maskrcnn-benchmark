...
class MobileNetV2FeatureExtractor_0(nn.Module):
    """
    Heads for FPN for classification
    """
    ...
    def __init__(self, cfg):
        ...
        # representation_size = cfg.MODEL.ROI_BOX_HEAD.MLP_HEAD_DIM
        self.pooler = pooler
        # self.fc_mobilenetv2 = nn.Linear(input_size, representation_size)
        # self.fc7 = nn.Linear(representation_size, representation_size)
        #
        # for l in [self.fc6, self.fc7]:
        #     # Caffe2 implementation uses XavierFill, which in fact
...
class FPNMobileQuadFeatureExtractor(nn.Module):
    """
    Heads for FPN for classification
    """

    def __init__(self, cfg):
        super(FPNMobileQuadFeatureExtractor, self).__init__()
        ...
        # for l in [self.fc6_pbox, self.fc7_pbox]:
            ...
            # nn.init.kaiming_uniform_(l.weight, a=1)
            # nn.init.constant_(l.bias, 0)
        self.mobilequad = MobileNetV2.bquadBottle()
...
_ROI_BOX_FEATURE_EXTRACTORS = {
    ...
    "FPN2MLPFeatureExtractorICSTN": FPN2MLPFeatureExtractor,
    "MobileNetV2FeatureExtractor": MobileNetV2FeatureExtractor,
    "FPNMobileQuadFeatureExtractor": FPNMobileQuadFeatureExtractor,
}
