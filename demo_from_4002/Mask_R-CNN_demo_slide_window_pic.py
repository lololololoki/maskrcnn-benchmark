...
def main():
    ...
    for image_path in tqdm(image_path_list):
        ...
        image_draw = coco_demo.overlay_tqr_boxes(image_draw, final_predictions)
        print (image_path.replace("jpg_for_draw", "output_overlap_0"))
        cv2.imwrite(image_path.replace("jpg_for_draw", "output_overlap_0"), image_draw)
